...
2025-11-14 - Wired unified_search to accept act_id="*" for multi-act aggregation so the semantic search modal All Acts scope works, and documented the multi-act contract in docs/multi-act-readiness.md.
2025-11-14 - Fixed DOCX hierarchy stacking so Parts/Divisions use style levels for sibling relationships (un-nesting ITAA1936 Parts) and documented the STYLE_MAP depth rules for new acts.
