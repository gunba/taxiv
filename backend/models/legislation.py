...
class Provision(Base):
	...
	references_to = relationship("Reference", foreign_keys="[Reference.source_internal_id]",
								 back_populates="source_provision", cascade="all, delete-orphan")
	referenced_by = relationship("Reference", foreign_keys="[Reference.target_internal_id]",
								 back_populates="target_provision")
	terms_used = relationship("DefinedTermUsage", foreign_keys="[DefinedTermUsage.source_internal_id]",
							  back_populates="source_provision", cascade="all, delete-orphan")
