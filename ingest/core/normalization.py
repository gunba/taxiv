...
def normalize_reference(
	...
	if len(parts) > 1 and (
			parts[0].startswith("ITAA") or parts[0] == "Constitution" or parts[0] in ACT_MAPPINGS.values()):
	...
	if not id_part or id_part_lower in ['act', 'n_a', 'general', 'na', 'unknown', 'u', 's', 't', 'p', 'd', 'n', 'i',
										'ii', 'v', 'x']:
