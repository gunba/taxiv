...
* **Frontend (JSDoc/TSDoc):** Document complex functions, hooks, and components explaining their purpose, props, and
  return values.
...
* Update Policy: The Changelog must be updated by the Documentation Architect for every merged feature, fix, or
