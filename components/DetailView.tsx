          ...
          {data.references_to.length > 0 ? (
            <ul className="space-y-2">
              {data.references_to.map(reference => (
                <li key={`${reference.target_ref_id}-${reference.snippet ?? 'snippet'}`} className="bg-gray-900 border border-gray-700 rounded-md p-3">
          ...
          {data.referenced_by.length > 0 ? (
            <ul className="space-y-2">
              {data.referenced_by.map(item => (
                <li key={item.source_internal_id} className="bg-gray-900 border border-gray-700 rounded-md p-3">
          ...
          {data.defined_terms_used.length > 0 ? (
            <ul className="space-y-2">
              {data.defined_terms_used.map(term => (
                <li key={`${term.term_text}-${term.definition_internal_id ?? 'unknown'}`} className="bg-gray-900 border border-gray-700 rounded-md p-3">
